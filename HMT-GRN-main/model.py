...
class hmt_grn(nn.Module):
    ...
    def __init__(self, arg):
        ...
        self.geoHashEmbed2 = nn.Embedding(len(arg['index2geoHash_2']), arg['embedding_dim'], padding_idx=self.padding_idx)
        self.geoHashEmbed3 = nn.Embedding(len(arg['index2geoHash_3']), arg['embedding_dim'], padding_idx=self.padding_idx)
        self.geoHashEmbed4 = nn.Embedding(len(arg['index2geoHash_4']), arg['embedding_dim'], padding_idx=self.padding_idx)
        self.geoHashEmbed5 = nn.Embedding(len(arg['index2geoHash_5']), arg['embedding_dim'], padding_idx=self.padding_idx)
        self.geoHashEmbed6 = nn.Embedding(len(arg['index2geoHash_6']), arg['embedding_dim'], padding_idx=self.padding_idx)
